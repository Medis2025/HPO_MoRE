...
class HPOConfig:
    # REQUIRED
    backbone: str = "/cluster/home/gw/Backend_project/models/BioLinkBERT-base"
    model_dir: str = "/cluster/home/gw/Backend_project/NER/tuned/hpo_lora_onto"
    ...
    val_root: str = "/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/val"
    hpo_json: str = "/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/hpo.json"

    # optional encoder init from finetuned model dir or .pt state_dict
    init_encoder_from: Optional[str] = "/cluster/home/gw/Backend_project/NER/tuned/intention"
...
def _parse_args():
    ...
    ap.add_argument("--backbone", type=str, default="/cluster/home/gw/Backend_project/models/BioLinkBERT-base")
    ap.add_argument("--init_encoder_from", type=str, default="/cluster/home/gw/Backend_project/NER/tuned/intention/best_model.pt",
                    help="Either a HF model dir or a .pt state_dict file fine-tuned on the same BERT family.")
    ap.add_argument("--model_dir", type=str, default="/cluster/home/gw/Backend_project/NER/tuned/hpo_lora_onto")
    ap.add_argument("--train_roots", type=str, nargs="+", default=[
        "/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/GeneReviews",
        "/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/GSC+",
        "/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/ID-68",
    ])
    ap.add_argument("--val_root", type=str, default="/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/val")
    ap.add_argument("--hpo_json", type=str, default="/cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/hpo.json")
...
"""
python /cluster/home/gw/Backend_project/NER/process_bert/add_head/HPO/hpo_lora_hpoid.py   --backbone /cluster/home/gw/Backend_project/models/BioLinkBERT-base  
 --init_encoder_from /cluster/home/gw/Backend_project/NER/tuned/intention   --model_dir /cluster/home/gw/Backend_project/NER/tuned/hpo_lora_onto_Dhead 
     --train_roots       /cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/GeneReviews       
     /cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/GSC+       /cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/ID-68  
       --val_root /cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/val  
 --hpo_json /cluster/home/gw/Backend_project/NER/pheno/PhenoBERT/phenobert/data/hpo.json   --use_crf
